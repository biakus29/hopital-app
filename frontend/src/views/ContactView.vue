<template>
  <main class="contact-page" ref="pageRef" @mousemove="handleMouseMove">
    <!-- ══════════════════════════════════════
         DYNAMIC BACKGROUND
    ══════════════════════════════════════ -->
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div class="space-y-8 sr-child">
            <div class="info-lux-card ag-float--light">
              <div class="info-icon-wrap"><MapPin :size="24" /></div>
              <div>
            ...
            <div class="info-lux-card ag-float--medium" style="--float-delay: 0.2s">
              <div class="info-icon-wrap"><Phone :size="24" /></div>
              <div>
            ...
            <div class="info-lux-card ag-float--light" style="--float-delay: 0.4s">
              <div class="info-icon-wrap"><Mail :size="24" /></div>
              <div>
            ...
            <div class="info-lux-card ag-float--medium" style="--float-delay: 0.6s">
              <div class="info-icon-wrap"><Clock :size="24" /></div>
              <div>
          ...
          <div class="form-container-lux glass-premium p-10 sr-child" style="--delay: 0.2s">
            <div v-if="submitted" class="success-state text-center py-12">
              <div class="success-circle mb-6 mx-auto"><CheckCircle :size="48" /></div>
...
import { MapPin, Phone, Mail, Clock, CheckCircle } from 'lucide-vue-next'
