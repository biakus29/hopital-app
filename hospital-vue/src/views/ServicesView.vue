<template>
  <main class="services-page" ref="pageRef">
    <!-- ══════════════════════════════════════
         DYNAMIC BACKGROUND
    ══════════════════════════════════════ -->
    ...
    <section class="hero-services">
      ...
      <div class="container mx-auto px-4 text-center max-w-5xl relative z-10">
        ...
        <div class="hero-badges flex flex-wrap justify-center gap-6 mt-12 sr-child">
          <div class="mini-badge"><span class="icon">🔬</span> High Quality</div>
          <div class="mini-badge"><span class="icon">⚡</span> Rapidity</div>
          <div class="mini-badge"><span class="icon">🛡️</span> Reliability</div>
        </div>
      </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div v-for="(svc, i) in services" :key="i" 
            ...
            <div class="card-inner">
              <div class="card-icon-lux">{{ svc.icon }}</div>
              ...
              <div v-else>
                ...
                <form class="space-y-4" @submit.prevent="handleAppointment">
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <input v-model="appointmentForm.email" type="email" required placeholder="Email" class="lux-input" />
                  </div>
    ...
    <section class="final-cta-lux py-40 sr">
      ...
      <div class="container mx-auto px-4 relative z-10 text-center">
        ...
        <div class="cta-actions-lux sr-child" style="--delay: 0.2s">
          ...
          <RouterLink to="/contact" class="btn-outline-lux">Write to Us</RouterLink>
        </div>
      </div>
    </section>
  </main>
...
const extraInfos = [
  { icon: '🤖', title: 'Automation', text: 'Constant investment in new clinical chemistry technologies.' },
  { icon: '🔬', title: 'New Instruments', text: 'State-of-the-art equipment for increased precision and speed.' },
  { icon: '✔️', title: 'Strict Quality', text: 'Rigorous processes to ensure the excellence of every result.' },
  { icon: '♿', title: 'Accessibility', text: 'Wheelchair accessible establishment and autism-friendly welcome.' }
]
